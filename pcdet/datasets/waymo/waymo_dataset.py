...
class WaymoDataset(DatasetTemplate):
    ...
    def bbox2result_kitti(self,
        ...
        det_annos = kitti_utils.transform_annotations_to_kitti_format(net_outputs, map_name_to_kitti=map_name_to_kitti)
    ...
    def format_results(self,
        ...
        """
        #pklfile_prefix = results/waymo-car/kitti_results
        ...
        from .prediction_kitti_to_waymo import \
            KITTI2Waymo  # noqa
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default='/home/yaya/source/myOpenPCDet/tools/cfgs/dataset_configs/waymo_dataset.yaml', help='specify the config of dataset')
